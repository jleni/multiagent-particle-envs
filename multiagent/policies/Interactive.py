...
# interactive policies based on keyboard input
...
class InteractivePolicy(Policy):
    def __init__(self, env, agent_index):
        ...
        if env.viewers[agent_index] is None:
            return
        env.viewers[agent_index].window.on_key_press = self._key_press
        env.viewers[agent_index].window.on_key_release = self._key_release
